...
/** WordPress 数据库的名称 */
define('DB_NAME', 'aboutrui');

/** MySQL 数据库用户名 */
define('DB_USER', 'aboutrui_f');

/** MySQL 数据库密码 */
define('DB_PASSWORD', 'aboutrui');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'GoZQtx=mpA?mLek<|P6`-$ ?zzqb/DVNU3CTaMmC4^,I_cOlY$vN&6U0Mc9S`bap');
define('SECURE_AUTH_KEY',  '|~{i7*T>6_#Jm@/[n{UK0C^-WyD6kyOVIdFnbq)A|X]-2V>H^K$8xs`,{TM^,[qP');
define('LOGGED_IN_KEY',    '&GjX]M!{HkG5)N[lZvsAPn+B|@J]`[*fG|<1*JF=^po9R[.V8phbx~n-W6o].030');
define('NONCE_KEY',        ',wTr =o{#&>]6_-=E+svwoWCLj2THv3#E6+{7m}%1Oz!y0:+T6eIU[pE+RN`}3 o');
define('AUTH_SALT',        'y]EAW]D_(PT-yaJ:%R|w-z$$2E>/+S-jb6|wVU$i*)lHMxTA#m+6/N2C0T|vqG<9');
define('SECURE_AUTH_SALT', 'Z1Gmh]vCwOA(W|aNAR/i/Y1=jaT.o9!U%5vu3bZxhxv+(~|XC.Oq{x,SYs>+Q*mF');
define('LOGGED_IN_SALT',   '_A+PR;B[8uhr]y2&7%0d$<oU}${0c)0V3)M&EMPS%5d!4)-#K}K@}|A74L3nJZ,l');
define('NONCE_SALT',       'tE(}d1QX.:<8k<sh4RvwG=#>0e&<#E % biiEXn=:|sxs^:@`{z~uN>`64)bLzF7');
