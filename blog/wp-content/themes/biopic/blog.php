            ...
            <div class="innerContainer">
                ...
                <div class="main<?php echo $main_classes; ?>">
                    ...
                    <article>
                        ...
                        <section class="meta"><?php echo get_the_time('F j, Y', get_the_ID()); ?></span>,&nbsp;<span><?php the_author(); ?></span>,&nbsp;<a href="<?php echo get_permalink(); ?>#<?php _e('comments', 'biopic'); ?>"><?php comments_number(__('0 Comments', 'biopic'), __('1 Comment', 'biopic'), __('% Comments', 'biopic')); ?></a></section>
                        <section class="entry">
							<?php /*?><?php
