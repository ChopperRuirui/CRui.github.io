                            ...
                            <div class="blog-content">
                                <?php if (function_exists('the_post_thumbnail') && has_post_thumbnail()) { ?>
                                    ...
                                    <div class="blog-article-image">
                                        ...
                                        src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo $src[0]; ?>&amp;w=256&amp;zc=1" alt="<?php echo htmlspecialchars(get_the_title()); ?>"/>
                                        </a>
                                    </div>     
                                    <?php } else { ?>
                                        <div class="blog-article-image">
