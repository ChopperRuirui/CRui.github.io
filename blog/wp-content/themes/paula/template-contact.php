...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $gantry->language; ?>" lang="<?php echo $gantry->language; ?>" <?php echo ($gantry->get('facebook-enabled')) ? 'xmlns:fb="http://www.facebook.com/2008/fbml"':''; ?> <?php echo ($gantry->get('googleplus-enabled')) ? 'itemscope itemtype="http://schema.org/"':''; ?>>
    <head>
        ...
        /*LINK SLIDER*/
        if ($gantry->get('slider-enabled') == '1' && is_home() == 'true') {
    ...
    <body <?php echo $gantry->displayBodyTag(); ?>>
        ...
        <div id="rt-header-wrapper">
         ...
         <div class="body-wrapper">
            ...
            <?php /** Begin Slider For Jaw Templates **/ if ($gantry->get('slider-enabled') == '1' && is_home() == 'true') { ?>	 
                <div id="rt-featured"> 
                    <div class="rt-container">
               ...
               /** END Slider For Jaw Templates **/ 
                ...
                if (($gantry->countModules('featured-right') || $gantry->countModules('slider')) && is_home() == 'true') : ?>
                <div id="rt-featured"> 
                    <div class="rt-container">
            ...
            <?php /** Begin Slider navigation For Jaw Templates **/ 
                if ($gantry->get('slidernav-enabled') == '1' && is_home() == 'true') { ?>
            <div id="rt-slnav"> 
                    <div class="rt-container">
            ...
            <?php /** Begin Slider Navigation WP * */ if ($gantry->countModules('slnav') && is_home() == 'true')  : ?>
                <div id="rt-slnav"> 
                    <div class="rt-container">
            ...
            <?php /** Begin Main Body * */ ?>
            <?php echo $gantry->displayMainbody('contact', 'sidebar', 'standard', 'standard', 'standard', 'standard', 'standard'); ?>
            <?php /** End Main Body * */ ?>
