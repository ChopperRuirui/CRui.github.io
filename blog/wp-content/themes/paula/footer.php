...
<div class="rt-grid-3">
<div id="rt-sidebar-a">
<?php  if ($gantry->countModules('sidebar')) : ?>
            
                    <?php echo $gantry->displayModules('sidebar', 'standard', 'standard','3'); ?>
