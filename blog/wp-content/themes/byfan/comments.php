...
<!-- You can start editing here. -->
	...
	<?php if ( have_comments() ) : ?>
		...
		<h3 id="comments" class="league"><img src="wp-content/themes/byfan/images/comment-title.png" /></h3>
...
<?php endif; ?>
	...
	<div id="respond">
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<label for="author"><small><?php _e('Name', 'framework') ?> <?php if ($req) _e("(required)", 'framework'); ?></small></label> <input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" />
			<label for="email"><small><?php _e('Mail', 'framework') ?> <?php if ($req) _e("(required)", 'framework'); ?></small></label> <input type="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22" tabindex="3" />
			<label for="url"><small><?php _e('Webs', 'framework') ?></small></label></p>
