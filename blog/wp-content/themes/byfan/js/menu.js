...
function loadMenus() {
	...
	/*var menubar2 = document.getElementById('mymenu');
	if (menubar2) {
		var list2 = menubar2.getElementsByTagName('ul');
		for (var i = 0; i < list2.length; i++) {
			var menu2 = list2[i].parentNode;
			if(menu2.parentNode === menubar2) {
				new GhostlyMenu(menu2, align);
			} else {
				new GhostlyMenu(menu2, align, 1);
				menu2.firstChild.className += ' subtitle';
			}
		}
	}*/
}
